        ...
        public async Task<IActionResult> Register(UserPostVM userregVM)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (isExistUsername)
                {
                    ...
                    return NotFound("Bu İstifadəçi adı artıq mövcuddur. Başqa İstifadəçi adı istifadə edin");
                }

                bool isExistEmail = _userManager.Users.Any(us => us.Email == user.Email);
                if (isExistEmail)
                {
                    return NotFound("Bu Email adı artıq mövcuddur. Başqa Email adı istifadə edin"); ;
                }
